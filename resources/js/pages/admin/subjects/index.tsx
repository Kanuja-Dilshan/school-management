...
export default function Index({ subjects }: any) {
                        ...
                        <div className="flex items-end justify-between mb-8">
                            <div>
                                ...
                                <p className="text-lg text-slate-500 mt-2">
                                    View and manage all subjects in the school.
                                </p>
                            </div>
                                        ...
                                        {subjects.data.map((subject: any) => (
                                            ...
                                            >
                                                <td className="px-8 py-5">
                                                    <span className="inline-flex px-3 py-1 rounded-lg bg-slate-100 text-slate-700 font-bold text-sm">
                                                        {subject.code}
                                                    </span>
                                                </td>
                                                ...
                                                <td className="px-8 py-5 text-center">
                                                    {subject.is_available ? (
                                                        <span className="inline-flex px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-sm font-semibold">
                                                            Available
                                                        </span>
                                                    ) : (
                                                        <span className="inline-flex px-3 py-1 rounded-full bg-red-50 text-red-600 text-sm font-semibold">
                                                            Unavailable
                                                        </span>
                                                    )}
                                                </td>
